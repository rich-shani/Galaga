...
if (global.gameMode == GameMode.GAME_ACTIVE) {
        ...
        draw_sprite_ext(spr_shot, 0, shot1x, shot1y, global.scale, global.scale, shot1dir, c_white, 1);

        // Draw the second shot, similar to the first, using shot2x, shot2y, and shot2dir.
        draw_sprite_ext(spr_shot, 0, shot2x, shot2y, global.scale, global.scale, shot2dir, c_white, 1);
        ...
        if (dub1 == 1) {
            draw_sprite_ext(spr_shot, 0, shot1x + Ship.SHIP_SPACE, shot1y, global.scale, global.scale, shot1dir, c_white, 1);
        }
        ...
        if (dub2 == 1) {
            draw_sprite_ext(spr_shot, 0, shot2x + Ship.SHIP_SPACE, shot2y, global.scale, global.scale, shot2dir, c_white, 1);
        }
  ...
  //      }
        ...
        if (shipStatus == 0 || shipStatus == 2) {
			...
			if (global.roomname == "GalagaWars") {
				draw_sprite_ext(xwing_sprite_sheet,shipDirection,x,y,0.8,0.8,0,c_white,1);
			}
			else {
            ...
            if (shotMode == ShotMode.DOUBLE) {
				...
				if (global.roomname == "GalagaWars") {
					draw_sprite_ext(xwing_sprite_sheet,shipDirection,x+(Ship.SHIP_SPACE*2),y,0.8,0.8,0,c_white,1);
				}
				else {
