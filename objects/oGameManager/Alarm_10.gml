...
if (nextlevel == 1) {
    ...
    if (oPlayer.regain == 1) {
        ...
        if (instance_number(EnemyShot) > 0) {
            ...
            /// Calculate the hundreds, tens, and ones digits of the current level (global.Game.Level.current) for display.
...
if (nextlevel == 2) {
	...
	/// If in challenge mode (global.Game.Challenge.count == 0) and in the initial state (start == 0),
