...
if (high_score_result.is_high_score) {
    ...
    // Shift all scores below the new score down by global.Game.Controllers.uiManager.scoreDisplay.ones position
    ...
    if (high_score_result.position == 1) {
        ...
        global.Game.Controllers.audioManager.playSound(G1st15);
    } else {
        // Top 5 but not #1
        global.Game.Controllers.audioManager.loopSound(G2nd);
    }
