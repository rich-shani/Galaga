...
// === HIGH SCORE INITIALS ENTRY HANDLER ===
// This block executes when the game is prompting the player to enter their initials.
// It supports navigating characters (left/right) and selecting them (space key).
...
if gameMode == GameMode.ATTRACT_MODE {
    ...
    if keyboard_check_pressed(vk_space) == true {
        ...
        exit;  // Exit this code block so the below doesn't run yet
    }
}
