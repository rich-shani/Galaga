...
/// @description Maximum value for breathing animation global.Game.Input.characterCycle
...
///              This specific value ensures breathing global.Game.Input.characterCycle aligns with audio loop timing
